...
class AllinoneAccessibilityProcessWire extends Process implements Module {

  public static function getModuleInfo() {
      return [
          'title' => 'All in One Accessibility',
          'version' => 100,
          'summary' => 'All in One Accessibility widget improves ProcessWire website ADA compliance and browser experience for ADA, WCAG 2.1, Section 508, Australian DDA, European EAA EN 301 549, UK Equality Act (EA), Israeli Standard 5568, California Unruh, Ontario AODA, Canada ACA, German BITV, and France RGAA Standards.',
          'author' => 'Skynet Technologies USA LLC',
          'autoload' => true,
          'singular' => true,
          'requires' => ['ProcessWire>=3.0.0'],
          'permission' => 'all-in-one-accessibility',
  ...
  {
      // Don't inject on ProcessWire admin
      if ($this->wire('page') && $this->wire('page')->template->name === 'admin') {
          return;
      }

      $this->addHookAfter('Page::render', $this, 'injectFrontendJS');
  }

  public function injectFrontendJS(HookEvent $event)
  {
      // Extra safety: don't inject on admin pages
      $page = $event->object;
      ...
      // Load local JS file
      $moduleUrl = $this->config->urls->AllinoneAccessibilityProcessWire;

      $script = '<script src="' . $moduleUrl . 'allinoneaccessibility.js"></script>';

      $event->return = str_replace(
          '</body>',
          PHP_EOL . $script . PHP_EOL . '</body>',
          $output
      );
  }
  public function ___execute() 
  {
          ...
          echo '<link rel="stylesheet"
              type="text/css"
              href="' . $this->config->urls->AllinoneAccessibilityProcessWire . 'css/style.css" />';
    ...
    <div id="skynet-plugin-config"
          data-plugin-base-url="<?php echo $this->config->urls->AllinoneAccessibilityProcessWire; ?>">
    </div>
    ...
    <body>
                ...
                <div class="all-one-accessibility-form">
                      ...
                      <div class="mb-3 row">
                        <div class="col-sm-12">
                          <div class="header-content">
                            <h1 class="mb-0 text-black" style="text-align: center;">
                              <img src="https://ada.skynettechnologies.us/public/trial-assets/images/all-in-one-accessibility-logo.svg"
                                  alt="All in One Accessibility - Skynet Technologies" style="">
                            </h1>
                          </div>
                          <div class="form-text">
                        ...
                        <div class="row">
                          <div class="col-auto">
                            <div class="input-group mb-3">
                              <input type="number" style="height:auto;border-bottom-right-radius: 0px;border-top-right-radius: 0px;" min="0" max="250" class="form-control" id="custom_position_x_value"
                  ...
                  <div class="mb-3 row widget-position" id="position_html">
                    ...
                    <div class="col-sm-12 three-col">
                      ...
                      <div
                        class="js-form-item form-item js-form-type-radio form-type-radio js-form-item-position form-item-position">
                        <input type="radio" id="edit-position-bottom-right" checked="" name="position" value="bottom_right"
                          class="form-radio" />
                  ...
                  <div class="form-radios  mb-3">
                    ...
                    <div class="form-radio-item">
                      <input data-drupal-selector="edit-widget-size-oversize"
                        ...
                        name="widget_size" value="1" class="form-radio form-boolean form-boolean--type-radio" wfd-id="id16">
                    ...
                    <div style="font-size: small;" id="edit-widget-size--wrapper--description"
                      data-drupal-field-elements="description" class="fieldset__description">It only works on desktop view.
                    </div>
                  </div>


                  <div class="icon-type-wrapper row " id="select_icon_type">
                    <label class="fcol-sm-12 col-form-label mb-4" style=" margin-right: -10.500px;">Select icon
                      type:</label>
                    <div class="col-sm-12" style=" margin-right: -15px;">
                      <div class="row">
                        <div class="col-auto mb-30">
                          <div
                            class="js-form-item form-item js-form-type-radio form-type-radio js-form-item-position form-item-position">
                            <input type="radio" id="edit-type-1" checked="" name="aioa_icon_type" value="aioa-icon-type-1"
                              class="form-radio" />
                          ...
                          <div class="col-auto controls ms-0">
                            ...
                            <div class="input-group mb-2">
                              <!-- <input type="number" class="form-control" style="height:auto" id="widget_icon_size_custom"
                                name="widget_icon_size_custom" oninput="this.value = Math.min(Math.max(this.value, 0), 150)"
                                value="" min="20" max="150" aria-label="Value in pixels"
                    ...
                    <div class="col-sm-12">
                      <div class="row">
                        ...
                        <div class="col-auto mb-30">
                          <div
                            class="js-form-item form-item js-form-type-radio form-type-radio js-form-item-position form-item-position">
                            <input type="radio" id="edit-size-default" name="aioa_icon_size_mb" value="aioa-default-icon-mb"
                              class="form-radio" />
                            <label for="edit-size-default" class="option">
                              <img src="https://www.skynettechnologies.com/sites/default/files/aioa-icon-type-1.svg"
                                width="55" height="55" />
                  ...
                  <div class="save-changes-btn">
                    <button type="button" id="submit" onclick="f1()" class="btn btn-primary" style="padding: 2%;background-color: #420083; color:white;">Save Changes</button>
      ...
      <script>
          ...
          fetch(apiUrl, {
            ...
            .then((result) => {
              ...
              if (result && result.Data && Object.keys(result.Data).length > 0) {
                ...
                // Handle cases where result or result.Data is not valid
              }
            })
            .catch(error => {
        ...
        $("#custom-size-switcher").off("click").on("click", function() {
        ...
        'input[name="position"][value="' + settings.widget_position + '"]'
        );
        ...
        const widget_size = document.querySelector(
          'input[name="widget_size"][value="' + settings.widget_size + '"]'
        );
        ...
        // console.log(settings.widget_icon_type);
        ...
        $(document).ready(function () {
            ...
            $("#custom-size-switcher").off("change").on("change", function () {

                const checked = this.checked;

                $(".custom-size-controls").toggleClass("hide", !checked);

                $(".widget-icon").toggleClass("hide", checked);

                is_widget_custom_size = checked ? 1 : 0;

            });

            $("#custom-position-switcher").off("change").on("change", function () {

                const checked = this.checked;

                $(".custom-position-controls").toggleClass("hide", !checked);

                $(".widget-position").toggleClass("hide", checked);

                is_widget_custom_position = checked ? 1 : 0;
        ...
        const widgetInput = document.getElementById("widget_icon_size_custom");

        if (widgetInput && ico_size_value) {
            widgetInput.value = ico_size_value;
        }
